...
if __name__ == '__main__':
    ...
    for ent in pes:
        ...
        if ent_type == 'domains':
            ...
            pe_doms[dom]['critical_targets'] = 0
            pe_doms[dom]['high_targets'] = 0
            pe_doms[dom]['medium_targets'] = 0
            pe_doms[dom]['low_targets'] = 0
